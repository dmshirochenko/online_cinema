    ...
    def get_queryset(self):
        results = (
            ...
            .annotate(
                ...
                actors=ArrayAgg("persons__person__full_name", filter=Q(persons__role="actor"), distinct=True),
                directors=ArrayAgg("persons__person__full_name", filter=Q(persons__role="director"), distinct=True),
                writers=ArrayAgg("persons__person__full_name", filter=Q(persons__role="writer"), distinct=True),
            )
        )
        return results
